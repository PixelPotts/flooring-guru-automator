...
import { Users, Link2, AlertCircle, CheckCircle2 } from 'lucide-react';

const LeadIntegrations: React.FC = () => {
  ...
  const leadServices = [
    {
      id: 'zillow',
      name: 'Zillow',
      description: 'Import leads from Zillow Premier Agent',
      icon: Users
    },
    {
      id: 'homeadvisor',
      name: 'HomeAdvisor',
      description: 'Sync leads from HomeAdvisor Pro',
      icon: Users
    },
    {
      id: 'angi',
      name: 'Angi',
      description: 'Connect with Angi Leads platform',
      icon: Users
    }
  ];
        ...
        >
          <div className="flex items-start justify-between mb-6">
            <div className="flex items-center">
              <div className="p-3 bg-yellow-100 dark:bg-yellow-900/30 rounded-xl mr-4">
                <service.icon className="h-6 w-6 text-yellow-600 dark:text-yellow-400" />
              </div>
              <div>
          ...
          {connectedServices.has(service.id) ? (
            ...
            <button
              ...
              className="w-full px-4 py-2 bg-yellow-600 text-white rounded-lg hover:bg-yellow-700 transition-colors duration-200 flex items-center justify-center"
            >
              <Link2 className="h-5 w-5 mr-2" />
