...
import { Star, Link2, AlertCircle, CheckCircle2 } from 'lucide-react';

const ReviewIntegrations: React.FC = () => {
  ...
  const reviewServices = [
    ...
    },
    {
      ...
      description: 'Monitor and manage Yelp reviews',
      icon: Star
    },
    {
      id: 'bbb',
      name: 'Better Business Bureau',
      description: 'Track and respond to BBB reviews',
      icon: Star
    }
  ];
        ...
        >
          ...
          {connectedServices.has(service.id) ? (
            ...
            <button
              ...
              className="w-full px-4 py-2 bg-amber-600 text-white rounded-lg hover:bg-amber-700 transition-colors duration-200 flex items-center justify-center"
            >
              <Link2 className="h-5 w-5 mr-2" />
...
export default ReviewIntegrations;