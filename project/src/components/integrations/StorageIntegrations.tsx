...
import { FolderOpen, Link2, AlertCircle, CheckCircle2 } from 'lucide-react';

const StorageIntegrations: React.FC = () => {
  ...
  const storageServices = [
    {
      id: 'google_drive',
      name: 'Google Drive',
      description: 'Store and manage project documents and files',
      icon: FolderOpen
    },
    {
      id: 'dropbox',
      name: 'Dropbox',
      description: 'Cloud storage for project files and sharing',
      icon: FolderOpen
    }
  ];
